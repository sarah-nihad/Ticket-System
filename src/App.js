...
class App extends React.Component {
  ...
  componentDidMount() {
    if (cookies.get("token")) {
      ...
      //         this.setState({title:res.data.data[0].task_title,customer:res.data.data[0].customer.name })
      ...
      <BrowserRouter >
        ...
        <Context.Provider value={{
          ...
          <Switch>
            ...
            <Route path='/Customers' component={Si} />
            ...
            <Route path='/Detials_TaskEdit' component={Si} />
